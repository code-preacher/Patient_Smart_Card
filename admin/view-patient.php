     ...
     $lib->check_login2();
       ...
       if (isset($_GET['id'])) {
       $crud->deleteTwoTable($_GET['id'],'patient','login','view-patient.php');
     }
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                           ...
                           foreach($qt as $dy){
                            ...
                            <tr>
                             ...
                             <td><?php echo $dy['date']; ?></td>
                              <td>
                              <a href="view-patient.php?id=<?php echo $dy['email']; ?>" onClick="return confirm('Are you sure you want to delete this record?')"><i class="mdi mdi-washing-machine"></i></a></td>
                      ...
                      echo "<tr><td colspan='9'><center>No Patient at the moment</center</td></tr>";
                    }
                    ?>
