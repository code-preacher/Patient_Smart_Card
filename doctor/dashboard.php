        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-2 col-xlg-2">
                <div class="card card-hover">
                    <div class="box bg-success text-center">
                        <h1 class="font-light text-white"><i class="mdi mdi-collage"></i></h1>
                        <h6 class="text-white">All My Treatment History: <?php $dy=$crud->displayOneByEmail('doctor',$_SESSION['id']); echo $crud->countAllWithTwo('treatment_history','doctor_id',$dy['id']);  ?></h6>
                    </div>
                </div>
            </div>
