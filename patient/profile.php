...
$dy=$crud->displayOneByEmail('patient',$_SESSION['id']);
?>
                                ...
                                <div class="basic-form">
                                 <form action="profile.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-rounded" name="password" required="required" value=<?php echo $dy['password']; ?> >
                                    </div>
