                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table id="zero_config" class="table table-striped table-bordered">
                      ...
                      <?php
                      $qt=$crud->displayAllSpecificWithOrder('treatment_history','patient_id',$crud->displayIdByEmail('patient',$_SESSION['id']),'id','desc');
                      ...
                      if ($qt) {
                       ...
                       foreach($qt as $dy){
                        ...
                        <tr>
                         <td><?php echo $c++; ?></td>
                         <td><?php echo strtoupper($crud->displayNameById('doctor',$dy['doctor_id'])); ?></td>
